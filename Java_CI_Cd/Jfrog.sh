...
sudo wget  https://releases.jfrog.io/artifactory/bintray-artifactory/org/artifactory/oss/jfrog-artifactory-oss/7.55.6/jfrog-artifactory-oss-7.55.6-linux.tar.gz  
tar xvzf jfrog-artifactory-oss-7.55.6-linux.tar.gz 
