...
cd /opt/
sudo wget https://downloads.apache.org/tomcat/tomcat-8/v8.5.98/bin/apache-tomcat-8.5.98.tar.gz
sudo tar xvzf apache-tomcat-8.5.98.tar.gz 
sudo mv apache-tomcat-8.5.98 tomcat
cd /opt/tomcat/
